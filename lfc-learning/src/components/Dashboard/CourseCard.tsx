  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative w-full h-48 bg-gray-200 dark:bg-[var(--bg-tertiary)] overflow-hidden">
          {/* Main Image */}
          <img
            src={getThumbnailUrl()}
            alt={title}
          ...
          {imageStatus === 'error' && (
            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-300 flex items-center justify-center">
              <div className="text-center text-gray-500 dark:text-[var(--text-tertiary)]">
        ...
        <div className="flex flex-col flex-1 p-6">
          ...
          {duration && duration !== "NaN" && (
            <div className="flex items-center text-sm text-gray-500 dark:text-[var(--text-tertiary)] mb-3">
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span>{duration.replace(/(\d+)\s*(day|week|month|hour|minute)s?/gi, (_match, num, unit) => {
