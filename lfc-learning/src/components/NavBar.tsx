    ...
    <header className="bg-gradient-to-b from-lfc-red via-lfc-red/95 to-lfc-red/90 dark:from-[var(--bg-elevated)] dark:via-[var(--bg-elevated)]/95 dark:to-[var(--bg-elevated)]/90 backdrop-blur-md sticky top-0 z-50">
      <div className="w-full max-w-screen-xl mx-auto px-4 py-3 flex justify-between items-center">
        <div className="flex items-center space-x-3">
          <div className="relative h-10 w-10 bg-white dark:bg-[var(--bg-tertiary)] rounded-xl p-1.5 shadow-md">
            <img 
              src="/logo.png" 
              alt="LFC Jahi Tech"
            />
          ...
          <div>
            <h1 className="text-lg font-bold text-white dark:text-[var(--text-primary)]">LFC Jahi Abuja</h1>
            <p className="text-xs text-white/80 dark:text-[var(--text-secondary)]">Technical Training</p>
          </div>
        </div>
        <Link
          to="/signup"
