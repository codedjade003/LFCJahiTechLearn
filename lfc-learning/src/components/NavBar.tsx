...
export default function Navbar() {
  return (
    <header className="bg-gradient-to-b from-lfc-red via-lfc-red/95 to-lfc-red/90 dark:from-[var(--bg-elevated)] dark:via-[var(--bg-elevated)]/95 dark:to-[var(--bg-elevated)]/90 backdrop-blur-md border-b border-lfc-gold/20 dark:border-red-800/30 shadow-lg sticky top-0 z-50">
